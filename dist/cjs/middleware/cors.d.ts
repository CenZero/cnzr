 ...
 * ```
 */
export declare function corsMiddleware(ctx: CenzeroContext, next: () => Promise<void>): Promise<void>;
/**
 ...
 * ```
 */
export declare function createCorsMiddleware(options?: CorsOptions): (ctx: CenzeroContext, next: () => Promise<void>) => Promise<void>;
/**
 ...
 * ```
 */
export declare function corsWithOrigins(allowedOrigins: string[]): (ctx: CenzeroContext, next: () => Promise<void>) => Promise<void>;
/**
 ...
 * ```
 */
export declare function corsWithCredentials(ctx: CenzeroContext, next: () => Promise<void>): Promise<void>;
