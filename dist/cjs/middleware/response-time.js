...
exports.createResponseTimeMiddleware = createResponseTimeMiddleware;
exports.preciseResponseTime = preciseResponseTime;
exports.responseTimeWithLogging = responseTimeWithLogging;
exports.createCustomResponseTime = createCustomResponseTime;
exports.createFormattedResponseTime = createFormattedResponseTime;
/**
 ...
 * ```
 */
function responseTimeMiddleware(ctx, next) {
 ...
 * ```
 */
function createResponseTimeMiddleware(options = {}) {
 ...
 * ```
 */
function preciseResponseTime(ctx, next) {
 ...
 * ```
 */
function responseTimeWithLogging(ctx, next) {
    return createResponseTimeMiddleware({
        log: true,
        precision: 1
    })(ctx, next);
 ...
 * ```
 */
function createCustomResponseTime(headerName) {
    return createResponseTimeMiddleware({
        header: headerName
    });
}
 ...
 * ```
 */
function createFormattedResponseTime(formatter) {
    return createResponseTimeMiddleware({
        formatter
    });
}
